...
export class Configuration {
    ...
    constructor({ accessToken, apiKeys, basePath, credentials, encodeParam, encoder, password, username, withCredentials }: ConfigurationParameters = {}) {
        ...
        // init default API-Key-Authentication credential
        if (!this.credentials['API-Key-Authentication']) {
            this.credentials['API-Key-Authentication'] = () => {
                if (this.apiKeys === null || this.apiKeys === undefined) {
                    return undefined;
                } else {
                    return this.apiKeys['API-Key-Authentication'] || this.apiKeys['access_token'];
                }
            };
        }
    }
